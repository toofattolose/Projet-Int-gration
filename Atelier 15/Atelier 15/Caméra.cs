...
namespace AtelierXNA
{
    public abstract class Caméra : Microsoft.Xna.Framework.GameComponent
    {
        ...
        protected Vector3 PositionCaméraInitiale { get; set; }
        ...
        public void Déplacer(Vector3 positionJoueur)
        {
            Position = positionJoueur + PositionCaméraInitiale;
            CréerPointDeVue(Position, positionJoueur, Vector3.Up);
        }
    }
}
